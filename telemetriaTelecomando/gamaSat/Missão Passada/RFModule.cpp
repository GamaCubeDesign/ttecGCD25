...
void updateStatusPacket(uint8_t index) {
    ...
    //     ((uint8_t*)(&satPacket.data.healthData))[i] =
    ((uint8_t*)(&(dataBuffer.statusData[index])))[i];
    // }
...
void sendSatPacket() {
    DBG_Print("S:");
    DBG_Print(satPacket.length);
    DBG_Print(" ");
    DBG_Print((int)satPacket.operation.protocol);
    DBG_Print(" ");
...
void switchCaseSetOperationProtocol() {
    switch (gsPacket.operation.operation) {
        case GS_SET_OPERATION:
            ...
            satPacket.data.operation_echo.switch_active_thermal_control =
                gsPacket.data.operation.switch_active_thermal_control;
            satPacket.data.operation_echo.switch_attitude_control =
                gsPacket.data.operation.switch_attitude_control;
            satPacket.data.operation_echo.switch_imaging =
                gsPacket.data.operation.switch_imaging;
            satPacket.data.operation_echo.switch_imaging_mode =
                gsPacket.data.operation.switch_imaging_mode;
            satPacket.data.operation_echo.switch_stand_by_mode =
                gsPacket.data.operation.switch_stand_by_mode;
